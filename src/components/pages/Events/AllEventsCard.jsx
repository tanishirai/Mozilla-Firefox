        ...
        >
          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-end">
              <Link
                to={`/event/${id}`}
                className="text-white w-full mt-2 bg-gradient-to-br from-[#4438E0] to-[#1267CC] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-[#18194D] font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
              >
                Details
              </Link>
            </div>
