    ...
    <div>
      <Link to={`/event/${id}`}>
        <div
          ...
          className="card card-side bg-base-100 bg-gradient-to-br from-[#8e60de]
          to-blue-300 shadow-xl">
          <div className=" text-white bg-gradient-to-br from-[#4833D0] to-[#844FE7] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-[#18194D] text-center  h-full font-semibold rounded-lg text-2xl py-20 px-10 my-auto">
            {time}
          </div>
          <div className="card-body">
            ...
            <div className="md:flex mt-10 gap-5">
              {place_onsite ? (
                <h2 className="p-2  mb-1 text-sm bg-opacity-50 bg-[#655DCE] rounded-lg">
                  {place_onsite}
                </h2>
              ) : (
                ""
              ...
              {place_online ? (
                <h2 className="p-2  mb-1 bg-opacity-50 bg-[#655DCE] rounded-lg">
                  {place_online}
                </h2>
              ) : (
                ""
