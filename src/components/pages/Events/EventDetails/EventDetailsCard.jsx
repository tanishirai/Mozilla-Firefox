    ...
    <div className="max-w-screen-xl md:mx-auto mx-2 ">
      ...
      <div className="card my-5 mb-8 lg:card-side bg-opacity-40  shadow-xl">
        ...
        <div className="card-body md:w-[650px] mx-auto">
          <h2 className="card-title text-2xl font-extrabold text-[#6633B5]">
            {price}$
          </h2>
          ...
          <div className="card-actions items-center justify-between ">
            <label
              htmlFor="my_modal_6"
              className="btn bg-gradient-to-br text-white from-[#4438E0] to-[#1267CC] hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-[#18194D]"
            >
              Get Ticket
            </label>
            <h3 className="text-xl shadow-2xl  rounded-b-lg px-10 p-3 font-semibold text-[#6633B5] ">
              Speaker
            </h3>
          </div>
        </div>
